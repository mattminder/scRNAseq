...
# Save Classif
savefile = open(RES_FOLDER + 'log_ridge_GS_classif.txt', 'wb')
...
np.save(arr=herring_pred, file=RES_FOLDER+'log_ridge_GS_preds_herring.npy')
np.save(arr=joost_pred, file=RES_FOLDER+'log_ridge_GS_preds_joost.npy')
