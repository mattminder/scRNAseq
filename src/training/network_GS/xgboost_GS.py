...
# Save Classif
classif.save_model(RES_FOLDER + 'xgboost_GS_classif.model')
classif.dump_model(RES_FOLDER + 'xgboost_GS_classif.txt')
...
np.save(arr=herring_pred, file=RES_FOLDER+'xgboost_GS_preds_herring.npy')
np.save(arr=joost_pred, file=RES_FOLDER+'xgboost_GS_preds_joost.npy')
np.savetxt(RES_FOLDER+'xgboost_GS_preds_herring.csv', herring_pred, delimiter=',')
np.savetxt(RES_FOLDER+'xgboost_GS_preds_joost.csv', joost_pred, delimiter=',')
