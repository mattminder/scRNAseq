...
# Save Classif
savefile = open(RES_FOLDER + 'randomForest_' + str(n_pcs) + 'pcs_classif.txt', 'wb')
...
np.save(arr=herring_pred, file=RES_FOLDER+'randomForest_' + str(n_pcs) + 'pcs_preds_herring.npy')
np.save(arr=joost_pred, file=RES_FOLDER+'randomForest_' + str(n_pcs) + 'pcs_preds_joost.npy')
