...
# Save Classif
savefile = open(RES_FOLDER + 'randomForest_GBF_classif.txt', 'wb')
...
np.save(arr=herring_pred, file=RES_FOLDER+'randomForest_GBF_preds_herring.npy')
np.save(arr=joost_pred, file=RES_FOLDER+'randomForest_GBF_preds_joost.npy')
