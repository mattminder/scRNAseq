...
print('Fitting Model')
classif = lm.LogisticRegressionCV(penalty='l2',     # Ridge regularization
...
# Save Classif
savefile = open(RES_FOLDER + 'log_ridge_GBF_classif.txt', 'wb')
...
np.save(arr=herring_pred, file=RES_FOLDER+'log_ridge_GBF_preds_herring.npy')
np.save(arr=joost_pred, file=RES_FOLDER+'log_ridge_GBF_preds_joost.npy')
