...
OUT_FOLDER = '../../../results/herring2017_predictions/'
...
prediction_handler(NO_LOW_VAR_FOLDER+'herring2017_rescaled_nolovar.npy',
                   CLASSIF_FOLDER+'base_features/randomForest_classif.txt',
                   OUT_FOLDER+'randomForest_base_features_herring2017_preds.npy')

prediction_handler(NO_LOW_VAR_FOLDER+'herring2017_rescaled_nolovar.npy',
                   CLASSIF_FOLDER+'base_features/log_lasso_no_lovar_classif.txt',
                   OUT_FOLDER+'log_lasso_base_features_herring2017_preds.npy')

prediction_handler(NO_LOW_VAR_FOLDER+'herring2017_rescaled_nolovar.npy',
                   CLASSIF_FOLDER+'base_features/log_ridge_no_lovar_classif.txt',
                   OUT_FOLDER+'log_ridge_base_features_herring2017_preds.npy')


# 500 PCs
PCA_FOLDER = '../../../results/pca/'

prediction_handler(PCA_FOLDER+'herring_500pcs.npy',
                   CLASSIF_FOLDER+'pca/log_lasso_500pcs_classif.txt',
                   OUT_FOLDER+'log_lasso_500pcs_herring2017_preds.npy')

prediction_handler(PCA_FOLDER+'herring_500pcs.npy',
                   CLASSIF_FOLDER+'pca/log_ridge_500pcs_classif.txt',
                   OUT_FOLDER+'log_ridge_500pcs_herring2017_preds.npy')

prediction_handler(PCA_FOLDER+'herring_500pcs.npy',
                   CLASSIF_FOLDER+'pca/randomForest_500pcs_classif.txt',
                   OUT_FOLDER+'randomForest_500pcs_herring2017_preds.npy')

# GS
prediction_handler(DATA_FOLDER+'herring2017_data_GS.npy',
                   CLASSIF_FOLDER+'network_GS/log_lasso_GS_classif.txt',
                   OUT_FOLDER+'log_lasso_GS_herring2017_preds.npy')

prediction_handler(DATA_FOLDER+'herring2017_data_GS.npy',
                   CLASSIF_FOLDER+'network_GS/log_ridge_GS_classif.txt',
                   OUT_FOLDER+'log_ridge_GS_herring2017_preds.npy')

prediction_handler(DATA_FOLDER+'herring2017_data_GS.npy',
                   CLASSIF_FOLDER+'network_GS/randomForest_GS_classif.txt',
                   OUT_FOLDER+'randomForest_GS_herring2017_preds.npy')

# GBF
prediction_handler(DATA_FOLDER+'herring2017_data_GBF.npy',
                   CLASSIF_FOLDER+'network_GBF/log_lasso_GBF_classif.txt',
                   OUT_FOLDER+'log_lasso_GBF_herring2017_preds.npy')

prediction_handler(DATA_FOLDER+'herring2017_data_GBF.npy',
                   CLASSIF_FOLDER+'network_GBF/log_ridge_GBF_classif.txt',
                   OUT_FOLDER+'log_ridge_GBF_herring2017_preds.npy')

prediction_handler(DATA_FOLDER+'herring2017_data_GBF.npy',
                   CLASSIF_FOLDER+'network_GBF/randomForest_GBF_classif.txt',
                   OUT_FOLDER+'randomForest_GBF_herring2017_preds.npy')
